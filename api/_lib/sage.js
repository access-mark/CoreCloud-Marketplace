// Serverless helper for Sage Accounting (Business Cloud)
...
const SAGE_VAT_STD_ID = process.env.SAGE_VAT_STD_ID;    // Your ZA 15% VAT rate id in Sage
...
module.exports = { upsertContact, createInvoice, allocateReceipt };
